...
class AppColors {
  ...
  // ── Material 3 tonal surface containers (low → high elevation) ─────────
  static const Color surfaceContainerLowest = Color(0xFF0F1C15);
  static const Color surfaceContainerLow = Color(0xFF172A1F);
  static const Color surfaceContainer = Color(0xFF1C3125);
  static const Color surfaceContainerHigh = Color(0xFF22392B);
  static const Color surfaceContainerHighest = Color(0xFF2A4434);

  // ── M3 outlines ────────────────────────────────────────────────────────
  static const Color outline = Color(0xFF4C5E52);
  static const Color outlineVariant = Color(0xFF2C3E33);
